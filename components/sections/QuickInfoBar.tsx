...
export default function QuickInfoBar() {
  return (
    <div className="bg-[#0F172A] text-white rounded-2xl shadow-xl p-6 sm:p-8">
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-4 divide-y md:divide-y-0 md:divide-x divide-slate-700/60">
        
        {/* Item 1: Address */}
        <div className="flex items-start gap-4 pt-4 md:pt-0 md:px-4 first:px-0">
          <div className="p-3 rounded-full bg-amber-500/10 border border-amber-400/30 text-amber-400 shrink-0">
          ...
          <div>
            ...
            <p className="text-xs font-medium text-slate-400">Bihar - 843316</p>
          </div>
        </div>
        ...
        <div className="flex items-start gap-4 pt-4 md:pt-0 md:px-4">
          ...
          <div>
            ...
            <p className="text-xs font-medium text-slate-400">Founder & Chief Mentor</p>
          </div>
        </div>
